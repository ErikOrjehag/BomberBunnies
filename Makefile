...
BomberBunnies.%: S=BomberBunnies.vhd CPU.vhd VGA_MOTOR.vhd MAP_MEMORY.vhd SPRITE_MEMORY.vhd TILE_MEMORY.vhd PROGRAM_MEMORY.vhd MICRO_MEMORY.vhd JOYSTICK.vhd
